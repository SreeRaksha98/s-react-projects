export { default as logo } from '../icon/project_icon.png';
export { default as HomePage } from "../Page/HomePage";
export { default as PetrolPumpPage } from "../Page/PetrolPump";
export { default as SubString } from "../Page/SubString";
...
export { default as Post } from "../Page/PostsComponent/Post";
export { default as Home } from "../Page/TravelComponent/Components/Home";
...
export { default as CounterApp } from "../Page/CounterApp/index"